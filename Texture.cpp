...
#include "stb_image.h"
Texture::Texture(Shader shader, const std::string fileName[], int texturNUm)
{
	...
	glUniform1i(glGetUniformLocation(shader.getProgramId(0), "diffuse"), 0);
	glUniform1i(glGetUniformLocation(shader.getProgramId(1), "bg"), 1);
